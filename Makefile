.PHONY: help spark-up spark-ps spark-logs spark-down spark-submit-smoke spark-submit-member-profile spark-submit-member-exports spark-submit-redemption-ingestion
